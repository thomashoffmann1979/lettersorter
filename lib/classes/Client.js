  ...
  module.exports = Client = (function(superClass) {
    ...
    Client.prototype.onID = function(msg) {
      ...
      if ((msg.tag != null) && (msg.data != null)) {
        ...
        for (j = 0, len = list.length; j < len; j++) {
          id = list[j];
          results.push(this.addID(tag, id));
        }
        return results;
      }
    };
