(function() {
  var BAO, Client, EventEmitter, LED, Magellan, PIN, colors, fs, osenv, path, socket, udpfindme, util,
  ...
  module.exports = Client = (function(superClass) {
    ...
    Client.prototype.onDiscoveryFound = function(data, remote) {
      if (typeof data.type === 'string') {
        if (data.type === 'sorter') {
          if (this.discoverd === false) {
            this.discoverd = true;
            this.url = 'http://' + remote.address + ':' + data.port + '/';
            return this.setIO();
          } else if (this.connected === false) {
            this.new_url = 'http://' + remote.address + ':' + data.port + '/';
            console.log(this.url, this.new_url, this.url === this.new_url);
            if (this.new_url !== this.url) {
    ...
    Client.prototype.setIO = function() {
      ...
      return this.io.on('add id', (function(_this) {
        return function(data) {
